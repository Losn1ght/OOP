...
public class Main {
    public static void main(String[] args){
        Name n1 = new Name();
        Name n2 = new Name("Juab");
        Name n3 = new Name("Juab","Jedd");
        Name n4 = new Name("Juab","Jedd","Cahiles");
        Name n5 = new Name();
        ...
        n5.setName("Juab", "Jan", "Curimatmat");
        ...
        Employee e3 = new Employee(2,"Jedd","Juab");
        Employee e4 = new Employee(3,"Christian", "Juab", "Cahiles");
        Employee e5 = new Employee(5, "Marc","Onikawa");

        System.out.println("\n");

        e1.setEmpID(9);
        e1.setEmpName("Jan","Appari","Juab");
